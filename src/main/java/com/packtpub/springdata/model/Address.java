...
public class Address {
	...
	public String toString() {
		return "Address [country=" + country + ", streetAddress=" + streetAddress + ", postCode=" + postCode
				+ ", postOffice=" + postOffice + ", state=" + state + ", getCountry()=" + getCountry()
				+ ", getStreetAddress()=" + getStreetAddress() + ", getPostCode()=" + getPostCode()
				+ ", getPostOffice()=" + getPostOffice() + ", getState()=" + getState() + ", getClass()=" + getClass()
