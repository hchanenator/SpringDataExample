 ...
 * 
 */
package com.packtpub.springdata.dto;

import org.hibernate.validator.constraints.Email;
import org.hibernate.validator.constraints.Length;
import org.hibernate.validator.constraints.NotEmpty;

import com.packtpub.springdata.model.Address;
...
public class ContactDTO {
	...
	public String toString() {
		return "ContactDTO [id=" + id + ", country=" + country + ", emailAddress=" + emailAddress + ", firstName="
				+ firstName + ", lastName=" + lastName + ", phoneNumber=" + phoneNumber + ", postCode=" + postCode
				+ ", postOffice=" + postOffice + ", state=" + state + ", streetAddress=" + streetAddress + "]";
	}
